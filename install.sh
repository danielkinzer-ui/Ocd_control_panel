...
# Run from GitHub: bash <(curl -fsSL https://raw.githubusercontent.com/YOUR_REPO/ocd-control/main/install.sh)

set -euo pipefail

REPO_URL="${OCD_REPO:-https://github.com/YOUR_USERNAME/ocd-control}"
...
echo "=========================================="
echo ""
echo "1. Start the daemon (in THIS Termux session):"
echo "   bash $INSTALL_DIR/start.sh"
echo ""
echo "   → Copy the TOKEN printed (e.g. 'aBcDeFgHiJkLmNoPqR')"
echo ""
echo "2. In a NEW Termux session, serve the panel:"
echo "   bash $INSTALL_DIR/serve-panel.sh 8080"
echo ""
echo "3. Open in browser:"
echo "   http://127.0.0.1:8080/panel.html"
echo ""
echo "4. Enter:  Host=127.0.0.1  Port=18790  Token=<your-token>"
echo ""
echo "=========================================="
...
echo "On laptop: http://<phone-ip>:8080/panel.html"
echo ""
echo "=========================================="